...
class _CreateDisputeScreenState extends State<CreateDisputeScreen> {
  ...
  Future<void> _loadBookings() async {
    ...
    try {
      ...
      final bookings = await apiService.getBookings(musicianId: uid).timeout(
          ...
          items: _bookings.isEmpty 
            ...
            : _bookings.map((booking) {
                return DropdownMenuItem<String>(
                  value: booking['id'],
                  child: Text(
                    '${booking['gigTitle']} (Organizer: ${booking['organizerName']})',
      ...
      children: [
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            child: Column(
              children: [
                const Icon(Icons.upload_file, size: 32, color: Color(0xFFA1F301)),
                const SizedBox(height: 12),
