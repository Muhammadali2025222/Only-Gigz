...
class CalendarEventModel {
  final String id;
  final String userId;
  final String userType; // 'organizer' | 'musician'
  final String source; // 'onlygigz_gig' | 'onlygigz_booking' | 'outside_gig' | 'availability_block' | 'unavailable_block' | 'hold'
  final String? gigId;
  ...
  final bool isAllDay;
  final String status; // 'OPEN_DATE' | 'POSTED' | 'REVIEWING' | 'BOOKED' | 'CONFIRMED' | 'COMPLETED' | 'CANCELLED' | 'AVAILABLE' | 'UNAVAILABLE' | 'HOLD' | 'OUTSIDE_GIG'
  ...
  factory CalendarEventModel.fromFirestore(Map<String, dynamic> snapshot, String docId) {
    ...
    return CalendarEventModel(
      ...
      userType: snapshot['userType'] ?? 'organizer',
      source: snapshot['source'] ?? 'onlygigz_gig',
